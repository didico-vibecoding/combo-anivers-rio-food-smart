      ...
      <section className="confetti-bg bg-gradient-hero text-white">
        <div className="container-narrow relative z-10 py-16 md:py-24 lg:py-28">
          <div className="grid grid-cols-1 items-stretch gap-10 md:grid-cols-12 md:gap-10 lg:gap-14">
            {/* Foto da Paula - esquerda no desktop, primeiro no mobile */}
            <div className="order-1 md:col-span-5 flex justify-center md:justify-start">
              <Reveal delay={180}>
                <img
                  src={paulaEloize}
                  alt="Paula Eloize, fundadora da Food Smart"
                  className="w-full max-w-sm md:max-w-none md:w-auto h-auto md:h-full md:max-h-[520px] object-contain drop-shadow-2xl"
                  loading="eager"
                />
              </Reveal>
            </div>

            {/* Texto - direita no desktop, depois no mobile */}
            <div className="order-2 md:col-span-7 text-center md:text-left flex flex-col justify-center">
              <Reveal>
